...
-- First, ensure the users table supports both UUID and VARCHAR user IDs
-- The table should already be VARCHAR(255) from the Clerk migration, which works for both
